...
alter table "public"."order_items" add constraint "public_order_items_product_id_fkey" FOREIGN KEY (product_id) REFERENCES product(id) ON DELETE CASCADE not valid;
...
create policy "All authenticated user, all operations"
...
create policy "Allow autenticated users to SELECT"
on "public"."product"
as permissive
for all
to authenticated
